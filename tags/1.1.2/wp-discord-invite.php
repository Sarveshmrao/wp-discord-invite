...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <td><p>https://discord.gg/<input type="text" name="smr_discord_invite_link" value="<?php echo get_option('smr_discord_invite_link', 'abCxYz'); ?>" /></td>
        </tr>
        ...
        <td><input type="text" name="smr_discord_description" value="<?php echo get_option('smr_discord_description', 'My server is awesome coz of these'); ?>" /></td>
        </tr>

        <tr valign="top">
        <th scope="row">Author <a href="<?php echo admin_url('admin.php?page=discord-invite-help'); ?>">(HELP)</a></th>
        <td><input type="text" name="smr_discord_author" value="<?php echo get_option('smr_discord_author', 'You have been invited to a server!'); ?>" /></td>
        </tr>

        <tr valign="top">
        <th scope="row">Image URL <a href="<?php echo admin_url('admin.php?page=discord-invite-help'); ?>">(HELP)</a></th>
        <td><input type="text" id="smr_discord_image_url" name="smr_discord_image_url" value="<?php echo get_option('smr_discord_image_url'); ?>" /></td>
        </tr>

        <tr valign="top">
        <th scope="row">Embed color <a href="<?php echo admin_url('admin.php?page=discord-invite-help'); ?>">(HELP)</a></th>
        <td><input type="text" name="smr_discord_embed_color" value="<?php echo get_option('smr_discord_embed_color', '#f4f4f4'); ?>" class="smr-discord-embed-color-picker" /></td>
        </tr>
...
<?php //EMBED PREVIEW START ?>
	...
	<div class="embed-color-pill" id="embedPreviewPlace" style="background-color:<?php echo get_option('smr_discord_embed_color', '#f4f4f4'); ?>"></div>
	...
	<div class="_author">
	<a class="embed-author-name"><span style="color:white;font-size:0.8em"><span id="embedSayingPlace"><?php echo get_option('smr_discord_author', 'You have been invited to a server!'); ?></span></span></a>
	</div>
	<div class="_title"><a class="embed-title"><span id="embedTitlePlace"></span><?php echo get_option('smr_discord_title', 'My Awesome Discord Server'); ?></a></div>
	<div class="embed-description" style="color:#797a7a;width:300px;"><p><span id="embedInvitedByPlace" style="overflow-wrap: break-word;"><?php echo get_option('smr_discord_description', 'My server is awesome coz of these'); ?></span></p>
	</div>
	</div>
...
<table class="form-table">
        ...
        <tr valign="top">
        <th scope="row">Discord Webhook URL <a href="<?php echo admin_url('admin.php?page=wp-discord-invite-help'); ?>">(HELP)</a></th>
