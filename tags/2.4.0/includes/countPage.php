...
<table class="form-table">
        ...
        <td><input type="checkbox" name="smr_discord_webhook_enable" value="1"<?php if(isset($_POST['wp-discord-invite-oauth']) && isset($_POST['webhook'])) {
...
<p class="description hidden" id="wp_discord_webhook-desc">Check to enable webhook option. <br /><a href="https://docs.sarveshmrao.in/en/wp-discord-invite#webhook">More Info in Docs</a></p></td>
        ...
        <td><input type="text" name="smr_discord_webhook_url" value="<?php if(isset($_POST['wp-discord-invite-oauth']) && isset($_POST['webhook'])) {
          echo $_POST["webhook"];
