...
<table class="form-table">
        ...
        <td><input type="checkbox" name="smr_discord_webhook_enable" value="1"<?php checked(
...
<p class="description hidden" id="wp_discord_webhook-desc">Check to enable webhook option. <br /><a href="https://docs.sarveshmrao.in/en/wp-discord-invite#webhook">More Info in Docs</a></p></td>
        ...
        <td><input type="text" name="smr_discord_webhook_url" value="<?php echo get_option(
          "smr_discord_webhook_url"
        ); ?>" /><span class="dashicons dashicons-editor-help" onclick="$j('#wp_discord_webhook-url-desc').toggleClass('hidden');"></span>
<p class="description hidden" id="wp_discord_webhook-url-desc">Webhook URL to post to a Discord Channel <br /><a href="https://docs.sarveshmrao.in/en/wp-discord-invite#webhook">More Info in Docs</a></p></td>
        </tr>
